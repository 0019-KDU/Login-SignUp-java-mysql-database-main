...
public class SignUp extends javax.swing.JFrame {
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        if (validateInput(fullName, email, password)) {
            boolean success = UserService.signUp(fullName, email, password); // Replace with your actual signup logic

            if (success) {
                JOptionPane.showMessageDialog(new JFrame(), "Sign up successful! You can now login.", "Success",
                        JOptionPane.INFORMATION_MESSAGE);
                clearFields();
            } else {
                JOptionPane.showMessageDialog(new JFrame(), "Sign up failed. Please try again.", "Error",
     ...
     private boolean validateInput(String fullName, String email, String password) {
        ...
        if (fullName.isEmpty() || email.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(new JFrame(), "Please fill in all the fields", "Error",
                    JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
